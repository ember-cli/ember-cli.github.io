...
|host|String|H|
|test-port|Number|4201|tp|The test port to use when running tests. Pass 0 to automatically pick an available port|
...
|reporter|String|r||Test reporter to use tap|
